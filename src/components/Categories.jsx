  ...
  return (
    ...
    <div className="max-w-screen-2x1 container mx-auto xl:px-24 px-6 bg-gradient-to-r from-[#fafafa] from-0% to-[#fcfcfc] to-100%">
      <div className="text-center">
        <p
          className="text-red uppercase tracking-wide font-medium text-lg"
          id="subtitle"
        >
          Customer Favorites
        </p>
        <h1
          className="text-4xl md:text-5xl font-bold my-2 md:leading-snug leading-snug"
          id="title"
        >
          Popular Categories
        </h1>
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-8 justify-around items-center mt-12">
        {category.map((item, i) => (
          <div
            key={i}
            className="shadow-lg rounded-md bg-white py-6 w- mx-auto text-center cursor-pointer hover:-translate-y-4 duration-300 transition-all"
          >
